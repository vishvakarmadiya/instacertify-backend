 ...
 * @example : https://github.com/Aous-Mohammad/Animated-Slider
 */
...
$(document).ready(function () {
  ...
  var Childs = $("#slider header").length;
  ...
  for (counter = Childs; counter > 0; counter--) {
    $("#slider header:nth-child(" + counter + ")").css("zIndex", (place += 1));
    // this if you want to slideing in or right with fade
    if (counter != 1) {
      $("#slider header:nth-child(" + counter + ")").css("opacity", "0");
    }
  }
  $(".next").click(function () {
    var cur = "#slider header:nth-child(" + i + ")";
    var next = "#slider header:nth-child(" + (i + 1) + ")";
    var firstChild = "#slider header:nth-child(1)";
    if (i == 1) {
  ...
  $(".prev").click(function () {
    console.log(i);
    var cur = "#slider header:nth-child(" + i + ")";
    var prev = "#slider header:nth-child(" + (i - 1) + ")";
    var lastChild = "#slider header:nth-child(" + Childs + ")";
    if (i == 1) {
      if ($(cur).hasClass(animatedOut) || $(cur).hasClass(animatedOutP)) {
        $(cur).removeClass();

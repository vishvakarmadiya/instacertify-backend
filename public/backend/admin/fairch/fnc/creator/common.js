...
//display
web.Components.extend("_base", "_base", {
	 properties: [
	 {
        key: "display_header",
        inputtype: SectionInput,
		...
		afterInit:function(node, inputElement) {
			var selector = web.StyleManager.getSelectorForElement(node);
...
web.Components.extend("_base", "_base", ComponentBaseTypography);
...
web.Components.extend("_base", "_base", ComponentBaseSize);
...
web.Components.extend("_base", "_base", ComponentBaseMargin);
...
web.Components.extend("_base", "_base", ComponentBasePadding);
...
web.Components.extend("_base", "_base", ComponentDeviceVisibility);


web.Components.add("config/bootstrap", {
	...
	beforeInit: function (node) {
		...
		let cssVars = web.ColorPaletteManager.getAllCSSVariableNames(window.FrameDocument.styleSheets/*, ":root"*/);
				...
				properties.push({
					...
					onChange: function(node, value, input) {
						...
						if (this.data.type == "font") {
							...
							web.FontsManager.addFont(option.dataset.provider, value, node[0]);
						}

						web.StyleManager.setStyle(":root", this.data.selector, value);

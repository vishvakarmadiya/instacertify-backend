...
$(window).on("web.getHtml.before", function(event, doc) {
	$("[data-aos]", doc).removeClass("aos-init aos-animate");
});

$(window).on("web.getHtml.after", function(event, doc) {
	$("[data-aos]", doc).addClass("aos-init aos-animate");
});

//ignore aos classes for styles
web.Builder.ignoreClasses = web.Builder.ignoreClasses.concat(["aos-init", "aos-animate"]);
...
web.Components.extend("_base", "_base", ComponentBaseAnimateScroll);

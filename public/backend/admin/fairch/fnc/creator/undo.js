	...
	*/	
	addMutation : function(mutation) {	
		...
		*/
		...
		web.Builder.frameBody.trigger("web.undo.add", mutation);
	 },
	...
	restore : function(mutation, undo) {	
		...
		switch (mutation.type) {
			...
			case 'characterData':
			  ...
			  break;
			case 'style':
			  $("#vpgjs-styles", window.FrameDocument).html( undo ? mutation.oldValue : mutation.newValue );
			  break;
			case 'attributes':
		...
		web.Builder.frameBody.trigger("web.undo.restore", mutation);
	 },

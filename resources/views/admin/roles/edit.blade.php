                        ...
                        <div class="card card-outline card-outline6 card-primary mt-4">
                            ...
                            <div class="card-body priter mt-4">
                                <div class="modal-body">
                                    <form class="form-example" action="{{ route('admin.roles.update', $role->id) }}"
                                        method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            ...
                                            @foreach ($permissionParent as $parent)
                                                <div class="col-md-4">
                                                    <div class="card card-outline card-outline6 mt-4 card-primary">
                                                        <div
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" class="btn brn-save  btn-outline-warning">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

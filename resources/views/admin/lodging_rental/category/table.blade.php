<table class="table align-middle table-row-dashed fs-6 gy-5">
    <thead>
        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
            ...
            @canany(['lodging-categories-edit', 'lodging-categories-delete'])
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-45px me-5">
                            <img src="{{ asset('backend/admin/images/lodging_rental/categories/' . $category->image) }}"
                ...
                <td>
                    @if ($category->is_active == '1')
                        <a href="{{ route('admin.lodging-categories.show', $category->id) }}?status=0">
                            <div class="badge badge-light-success">Active</div>
                        </a>
                    @else
                        <a href="{{ route('admin.lodging-categories.show', $category->id) }}?status=1">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-more-details menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4 mt-10 new-dp1 dropdown-menu"
                                ...
                                <div class="menu-item px-3">
                                    @can('lodging-categories-edit')
                                        <a href="{{ route('admin.lodging-categories.edit', $category->id) }}"
                                    ...
                                    @can('lodging-categories-delete')
                                        ...
                                        <form action="{{ route('admin.lodging-categories.destroy', $category->id) }}"

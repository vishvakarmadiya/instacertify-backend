...
@section('content')
        ...
        <div class="app-toolbar py-3 py-lg-6">
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    @can('lodging-categories-create')
                        <a href="{{ route('admin.lodging-categories.create') }}" class="btn btn-sm fw-bold btn-primary">Create New
                            Category</a>
                    @endcan
                </div>
            </div>
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body pt-0">
                        ...
                        <div id="table">
                            @include('admin.lodging_rental.category.table')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function fillter() {
            $.ajax({
                type: 'GET',
                url: "{{ route('admin.lodging-categories.index') }}",

                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                    ...
                                    <div class="image-input-wrapper w-150px h-150px"
                                        style="background-image: url({{ asset('backend/admin/images/lodging_rental/amenities/' . $amenity->image) }})">
                                    </div>
                                    <label
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div
                                        class="rounded-circle @if ($amenity->is_active == '1') bg-success @else bg-danger @endif w-15px h-15px">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" name="is_active" data-control="select2"
                                    ...
                                    <option value="1" @if ($amenity->is_active == '1') selected @endif>Active</option>
                                    <option value="0" @if ($amenity->is_active == '0') selected @endif>Deactive</option>
                                </select>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="name" class="form-control mb-2"
                                                    placeholder="Category Name..." value="{{ $amenity->name }}"
                                                    required>

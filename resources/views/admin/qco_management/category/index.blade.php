...
@section('content')
            ...
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    @can('qco-categories-create')
                        <a href="{{ route('admin.qco-categories.create') }}" class="btn btn-sm fw-bold text-white" style="background-color:rgb(236, 105, 31)">Create New
                            Category</a>
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body pt-0">
                        ...
                        <div id="table">
                            @include('admin.qco_management.category.table')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function fillter() {
            $.ajax({
                type: 'GET',
                url: "{{ route('admin.qco-categories.index') }}",

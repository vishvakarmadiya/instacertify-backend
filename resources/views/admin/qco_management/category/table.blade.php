{{-- <table class="table align-middle table-row-dashed fs-6 gy-5">
    <thead>
        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
            ...
            @canany(['qco-categories-edit', 'qco-categories-delete'])
    ...
    <table class="table table-responsive align-middle fs-6 gy-5">
        <thead style="background-color: rgb(6, 81, 117); color: white; border-bottom: 2px solid #004761;">
            <tr class="text-start fw-bold fs-7 text-uppercase gs-0" style="letter-spacing: 0.05em;">
                ...
                @canany(['qco-cetegories-edit', 'qco-categories-delete'])
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-45px me-5">
                            <img src="{{ asset('backend/admin/images/qco_management/categories/' . $category->image) }}"
                ...
                <td>
                    @if ($category->is_active == '1')
                        <a href="{{ route('admin.qco-categories.show', $category->id) }}?status=0">
                            <div class="badge badge-light-success">Active</div>
                        </a>
                    @else
                        <a href="{{ route('admin.qco-categories.show', $category->id) }}?status=1">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-more-details menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4 mt-10 new-dp1 dropdown-menu"
                                ...
                                <div class="menu-item px-3">
                                    @can('qco-categories-edit')
                                        <a href="{{ route('admin.qco-categories.edit', $category->id) }}"
                                    ...
                                    @can('qco-categories-delete')
                                        ...
                                        <form action="{{ route('admin.qco-categories.destroy', $category->id) }}"

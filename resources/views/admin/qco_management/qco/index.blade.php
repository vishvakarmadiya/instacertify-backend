		...
		<!--begin::Toolbar-->
            <div class="custom-app-toolbar">
                ...
                <div class="right">
                    ...
                    <!--end::Menu This Week-->
                    @can('qco-categories-create')
                        <a href="{{ route('admin.qcos.create') }}" class="btn btn-sm fw-bold text-white" style="background-color: rgb(236, 105, 31)">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="section-status">
                        ...
                        <div class="box box-1">
                            <div class="inner">
                                <h5>New qcos</h5>
                                <h3> {{ App\Models\Admin\qco::where('is_delete', '0')->get()->count() }}</h3>
                            </div>
                        ...
                        <div class="box box-3">
                            <div class="inner">
                                ...
                                <h3> {{ App\Models\Admin\qco::where('is_delete', '0')->sum('number_of_tickets') }} Left
                                </h3>
                            </div>
                            <span class="with-icon">
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body pt-0" id="page-section-body">
                        ...
                        <div id="table">
                            @include('admin.qco_management.qco.table')
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            function toggleActive(id, button) {
               var csrfToken = "{{ csrf_token() }}";
                ...
                $.ajax({
                    url: '{{env('APP_URL') }}admin/qco/toggle-active/' + id,
                    type: 'POST',
                    dataType: 'json',
                    data: {

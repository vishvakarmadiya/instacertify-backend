...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" novalidate action="{{ route('admin.qcos.update', $qco->id) }}"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush">
                                        <div class="card-body">
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">qco Title</label>
                                                <input type="text" name="title" class="form-control mb-2"
                                                    placeholder="Name of qco" value="{{ $qco->title }}" required>
                                                <!-- <div class="text-muted fs-7">A qco title is required.</div> -->
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Short Description</label>
                                                <textarea name="short_description" rows="4" class="form-control mb-2" placeholder="Short Details about qco"
                                                    required>{{ $qco->short_description }}</textarea>
                                                <!-- <div class="text-muted fs-7">Set a short description to the qco.</div> -->
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea id="editor" name="description">{!! $qco->description !!}</textarea>
                                                        <!-- <div class="text-muted fs-7">Set a description to the qco for better visibility.</div> -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <label class="lbl-qcoMedia" for="qcoMedia">
                                                        ...
                                                        <input type="file" id="qcoMedia" name="images[]"
                                                            class="form-control qcoMedia"
                                                    ...
                                                    <div class="mediaFileList">
                                                        ...
                                                        @if ($qco->images)
                                                                @foreach ($qco->images as $key => $item)
                                                                    <li> <img
                                                                            src="{{ asset('backend/admin/images/qco_management/qcos/' . $qco->images[$key]) }}" /><button type="button" class="rm-img-btn" ><span aria-hidden="true">×</span></button>
                                                                            <input type="hidden" name="oldImages[]" value="{{$qco->images[$key]}}">
                                                                        </li>
                                                                @endforeach
                                                        @endif
														</ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-10">
                                                    <label class="required form-label">qco Location</label>
                                                    <div class="input-group input-gt">
                                                        <input type="text" class="form-control" name="location"
                                                            value="{{ $qco->location }}" placeholder="An qco venue"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div
                                                        ...
                                                        <label for="single_day">Single day qco</label>
                                                        <input type="checkbox" name="single_day" id="single_day"
                                                            onclick="showDateDiv()"
                                                            @if ($qco->single_day == '1') checked @endif>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-10 single_day">
                                                        ...
                                                        <input type="date" name="date" class="form-control mb-2"
                                                            value="{{ $qco->date }}" min="">
                                                        <!-- <div class="text-muted fs-7">Select qco Date.</div> -->
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-10 multiple_day d-none">
                                                            ...
                                                            <input type="date" name="end_date"
                                                                class="form-control mb-2" value="{{ $qco->end_date }}">
                                                            <!-- <div class="text-muted fs-7">Select qco Date.</div> -->
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        class="col-md-12 d-flex gap-2 align-self-center justify-content-end">
                                                        <input type="checkbox" name="all_day" id="all_day" onclick="showTimeDiv()" @if ($qco->all_day == '1') checked @endif>
                                                        <label for="all_day">All Day qco</label>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-2 all_day">
                                                            ...
                                                            <input type="time" name="start_time"
                                                                class="form-control mb-2"
                                                                value="{{ $qco->start_time }}">
                                                            <!-- <div class="text-muted fs-7">Select qco Start Time.</div> -->
                                                        </div>
                                                        <div class="col-md-6 mb-2 all_day">
                                                            <label class="required form-label">End Time</label>
                                                            <input type="time" name="end_time"
                                                                class="form-control mb-2" value="{{ $qco->end_time }}">
                                                            <!-- <div class="text-muted fs-7">Select qco End Time.</div> -->
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-10">
                                                    <label class="required form-label">qco Category</label>
                                                    <select class="form-select mb-2" name="category_ids[]"
                                                        data-control="select2" data-placeholder="Select an option"
                                                        data-allow-clear="true" multiple="multiple" required>
                                                        @foreach ($qco_categories as $qco_categorie)
                                                            <option value="{{ $qco_categorie->id }}"
                                                                @if (in_array($qco_categorie->id, $qco->category_ids)) selected @endif>
                                                                {{ $qco_categorie->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="text-muted fs-7">Select qco Categories.</div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-5">
                                                    ...
                                                    <input type="text" name="seo_title" class="form-control mb-2"
                                                        value="{{ $qco->seo_title }}" placeholder="Name of title">
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label">Seo Description</label>
                                                    <textarea name="seo_description" class="form-control mb-2" rows="4" placeholder="SEO Details">{{ $qco->seo_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-end gap-5 mb-20">
                            <a href="{{ route('admin.qcos.index') }}" class="btn btn-outline">
    ...
    <script>
        const files = $("#qcoMedia");
        const fileList = $(".mediaFileList ul");

        function getFileData() {
            var input = document.getElementById('qcoMedia');
            var children = "";

...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.qcos.store') }}"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    oninput="validate(this, 'title-warn')" placeholder="Name of qco"
                                                    required>
                                                <div id="title-warn" class="text-warning2 none fs-7">This qco title is
                                                    already exists</div>
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Short Description</label>
                                                <textarea name="short_description" rows="4" class="form-control form-control11 mb-2"
                                                    placeholder="Short Details about qco" required></textarea>
                                            ...
                                            <div class="row">
                                                {{-- <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" name="location" class="form-control mb-2" placeholder="An qco venue" required>
                                                ...
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <div class="input-group input-gt">
                                                        <input type="text" class="form-control form-control11"
                                                            name="location" placeholder="An qco venue"
                        ...
                        <div class="d-flex justify-content-end gap-5 mb-20">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">Create qco</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        async function validate(e, id) {
            console.log(e.value);
            let resp = await fetch(`https://fcdev.madfishdev.com/admin/validate-qco?title=${e.value}`);

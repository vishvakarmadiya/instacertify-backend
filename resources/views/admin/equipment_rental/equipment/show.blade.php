                    ...
                    <div class="row">
                                    ...
                                    <div class="slider slider-content" id ="event-gallery-main">
                                        ...
                                        <li >
											<img class="event-image"
                                                src="{{ asset('backend/admin/images/equipment_management/equipments/' . $item) }}">
                                        </li>
                                    @endforeach
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 event_coniy">
                            <div class="event-content">
                                ...
                                <h3 class="evt-title evt_title11">${{$equipment->price}} /night</h3>
                                ...
                                <p class="evt-short-description mt-2 evt1_short evt1_short1">{{$equipment->description}}</p>

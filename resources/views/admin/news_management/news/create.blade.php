...
@section('content')
    <style>
        ...
        .lbl-newsMedia>span b {
            color: #2A78C5;
        }

        .lbl-newsMedia .newsMedia {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.news.store') }}"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    oninput="validate(this, 'title-warn')" placeholder="Name of news"
                                                    required>
                                                <div id="title-warn" class="text-warning2 none fs-7">This news title is
                                                    already exists</div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <label class="lbl-newsMedia" for="newsMedia">
                                                        ...
                                                        <input type="file" id="newsMedia" name="images[]"
                                                            class="form-control newsMedia"
                                                ...
                                                <div class="col-md-12 mb-10">
                                                    ...
                                                    <select class="form-select mb-2 form-control11" name="category_ids[]"
                                                        ...
                                                        @foreach ($news_categories as $news_categorie)
                                                            <option value="{{ $news_categorie->id }}">
                                                                {{ $news_categorie->name }}</option>
                                                        @endforeach
                                                    </select>
                        ...
                        <div class="d-flex justify-content-end gap-5 mb-20">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">Create News</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        async function validate(e, id) {
            console.log(e.value);
            let resp = await fetch(`https://fcdev.madfishdev.com/admin/validate-news?title=${e.value}`);
    ...
    <script>
        ...
        const files = $("#newsMedia");
        const fileList = $(".mediaFileList ul");

        function getFileData() {
            var input = document.getElementById('newsMedia');
            var children = "";

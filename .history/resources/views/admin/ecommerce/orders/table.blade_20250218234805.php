...
<table class="table align-middle table-row-dashed fs-6 gy-5 table-row-bordered display" id="order_table">
    <thead>
...
<script>
    ...
    $("#order_table").DataTable({
        ...
        "lengthChange": true,      
        "pageLength": 10,      
        "pagingType": "full_numbers",  // ✅ Ensure previous & next buttons are visible
        "language": {
            "paginate": {
                "first": "First",  // ✅ Add "First" button
                "last": "Last",    // ✅ Add "Last" button
                "previous": "Previous", 
                "next": "Next"
            }
        }

<table class="table align-middle table-row-dashed fs-6 gy-5 table-row-bordered " id="order_table" class="table table-row-bordered gy-5">
    <thead>
...
<script>
   $(document).ready(function() {
    $("#order_table").DataTable({
        ...
        "lengthChange": true,
        "pageLength": 10,
        "order": [[0, "desc"]], // Ensure first column (ID) is sorted descending

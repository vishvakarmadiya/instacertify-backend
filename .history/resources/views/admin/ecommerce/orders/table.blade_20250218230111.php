...
<script>
    ...
    function showOrderDetails(order) {
        ...
        let orderInfoContent = `
            ...
            <tr><th>[Razorpay](w) Order ID</th><td>${order.razor_order_id || 'N/A'}</td></tr>
...
<script>
 $(document).ready(function() {
    $("#order_table").DataTable({
        ...
        "searching": false,        // Disable search functionality (optional)
        ...
        "language": {
            "paginate": {
                "previous": "Previous",  // Custom label for previous page
                "next": "Next"           // Custom label for next page
            }
        }
    });
});
